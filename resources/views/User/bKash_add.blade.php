            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-5 bg-white">
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        ...
                        <span style="margin-left: 3px;">01900000000 (Play for Money bKash Number)</span>
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-12 text-center">
                        <p style="color: red; font-size: 14px;">*First send money to Play for Money biKah personal number and verify your payment by entering your mobile number and amount you send.</p>
                    </div>
                </div>
                @if(session('message'))
                ...
                <div class="row mt-10">
                    <div class="col-12">
                        <form action="/transaction/bKash" method="post">
                            @csrf
                            <input type="number" class="form-control" name="amount_to_add" placeholder="How much you send?" required>
                            <input type="number" class="form-control mt-3 mb-3" name="bkash" placeholder="From which number?" required>
